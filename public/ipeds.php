...
$apiKeyInteractive  = $_ENV['API_KEY_INTERACTIVE'];
...
<head>
    ...
    $page_title = 'IPEDS: WRLC Consortium Loans Filled by Patrons
...
<body>
    ...
    function fetchXMLDataIpeds(string $startDate, string $endDate, string $location, string $apiKeyInteractive): SimpleXMLElement
    {
...
<div class="collapse" id="collapseExample"><div class="card card-body"><p><strong>Analytics Path:</strong>' . htmlspecialchars($pathValue) . '</p></div>
    ...
    if ($startDate && $endDate && $location) {
        $xmlData = fetchXMLDataIpeds($startDate, $endDate, $location, $apiKeyInteractive);
